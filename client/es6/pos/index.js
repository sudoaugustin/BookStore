...
$(document).ready(() => {
  ...
  var monthly_chart = new ApexCharts(
    document.querySelector(".total_sales #chart"),
    monthly_chart_options
  );
  monthly_chart.render();
  var session_chart = new ApexCharts(
    document.querySelector(".store_session #chart"),
    store_session_chart
  );
  session_chart.render();
  var avg_chart = new ApexCharts(
    document.querySelector(".average_value #chart"),
    avg_sale_options
  );
  avg_chart.render();
  $(".pp_img").click((e) => {
  ...
  axios
    ...
    .then((res) => {
      ...
      if (res.data.saleOfMonth > res.data.saleOfPrevMonth) {
        ...
        html =
          Math.round(res.data.saleOfMonth / res.data.saleOfPrevMonth) + "%";
        ...
        html =
          Math.round(res.data.saleOfPrevMonth / res.data.saleOfMonth) + "%";
      }
  ...
  axios
    ...
    .then((res) => {
      ...
      $(".store_session .trible_row .visitor").html(data.visitOfMonth);
      ...
      $(".store_session .trible_row .subscribe").html(data.subscribeOfMonth);
      console.log(res.data);
